...
<body>
    ...
    <form action="resultado.php" method="post">
        ...
        <p>Pergunta 3: Quantos planetas existem no sistema solar? (responda por extenso)</p>
        <input type="text" name="resposta3" required><br>

        <p>Pergunta 3: Ao juntar as cores azul e amarelo, qual cor temos?</p>
        <input type="text" name="resposta4" required><br>

        <p>Pergunta 3: Ao juntar as cores vermelho e amarelo, qual cor temos?</p>
